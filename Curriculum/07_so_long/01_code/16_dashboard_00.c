...
/*   Updated: 2023/10/20 21:17:10 by akekesi          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_img_dashboard(t_game *game)
{
	...
	mlx_image_to_window(game->mlx, game->img_dashboard_bgr,
	...
	game->img_dashboard_str = mlx_put_string(game->mlx, dashboard_str,
			DASHBOARD_X, DASHBOARD_Y);
